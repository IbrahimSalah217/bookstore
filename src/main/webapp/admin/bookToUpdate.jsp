                    ...
                    <div class="row">
                        <div class="col-xs-10 col-sm-10">
                            <div class="card">
                                ...
                                <form name="form" action="/BookStore/updatebook" method="Get">
                                    
                                    <div class="card-body">

                                        <select name="selectedBook" data-placeholder="Choose a book" class="selectpicker" data-live-search="true" data-live-search-style="startsWith">
