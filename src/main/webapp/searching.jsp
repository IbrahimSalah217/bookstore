...
<div class="container">
    <div class="row ">
        <div id="column-left" class="col-sm-4 col-md-4 col-lg-3 ">
            ...
            <form method="post" action="search?name=${requestScope.keyWord}">
                    ...
                    <div class="filter-block">
                        ...
                        <div class="list-group">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <select class="selectpicker" name="Categories" multiple data-live-search="true" id='cats'  title="Interests">
                                    <c:forEach items="${applicationScope.categories}" var="cate">
        ...
        <div id="column-right" class="col-sm-8 col-md-8 col-lg-9 mtb_30">
            ...
            <div id="product-tab" class="mt_40">
                <div class="heading-part mb_20 ">
                    <h2 class="main_title">${requestScope.keyWord} Books</h2>
                </div>
                <div class="tab-content clearfix box">
                    <div class="tab-pane active" id="nArrivals">
                        <div class="nArrivals owl-carousel">
                            <c:set var="remenderSearchResults" value="${fn:length(requestScope.searchResults) %2}"/>

                            <c:forEach items="${requestScope.searchResults}" begin="1" step="2" varStatus="seq1">
                                <div class="product-grid">
                                    <c:forEach items="${requestScope.searchResults}" var="book" begin="${seq1.index-1}" end="${seq1.index}">
                                        <div class="item">
                            ...
                            <div class="product-grid">
                                <c:forEach items="${requestScope.searchResults}" var="book" begin="${fn:length(requestScope.searchResults)-remenderSearchResults}" end="${fn:length(requestScope.searchResults)}">
                                    <div class="item">
                                        <div class="product-thumb">
                                            <div class="image product-imageblock">
                                                <a href="LoadBookPage?id=${book.bookId}">
